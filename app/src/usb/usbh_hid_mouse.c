...
USBH_StatusTypeDef USBH_HID_MouseInit(USBH_HandleTypeDef *phost) {
    ...
    USBH_HID_FifoInit(
        &HID_Handle->fifo, phost->device.Data, HID_QUEUE_SIZE * sizeof(mouse_report_data));
...
static USBH_StatusTypeDef USBH_HID_MouseDecode(USBH_HandleTypeDef *phost) {
    ...
    /*Fill report */
    if (USBH_HID_FifoRead(&HID_Handle->fifo, &mouse_report_data, HID_Handle->length)
        == HID_Handle->length) {
        /*Decode report */
